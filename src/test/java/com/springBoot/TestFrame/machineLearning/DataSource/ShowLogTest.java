...
public class ShowLogTest extends DataSourceBaseCase{
    ...
    public void ShowLogSucTest() throws Exception {
        ...
        JSONObject jsonObjectPre = JSON.parseObject(respDa);
        String operatorId = jsonObjectPre.getString("operatorId");
        ...
        dbMap.put("operatorId", operatorId);

        String resp = httpRequestUtil.doGet(ShowLogUrl, dbMap);
